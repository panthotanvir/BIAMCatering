...
window.onload = function(){
	...
	var ingredienturl = "<?php echo base_url() . "index.php/api/get/item_ingredient/{$item_id}"; ?> ";
...
<div class="row">
	<div class="span6 offset3 well">
		...
		<form method="POST">
			...
			<input type="text" name="item_name" id="item_name" value="<?php echo $item_data["item_name"]; ?>">
			<br/>
			<label for="people">Number of People:</label> 
			<input type="text" name="people" id="people" value="<?php echo $ingredients[0]["people"]; ?>">
			<br/>
			<p> 
